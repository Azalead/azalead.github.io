define({ "api": [
  ...
  {
    "type": "get",
    "url": "/core/account/:id/contact",
    "title": "Account's contacts",
    "version": "0.0.1",
    "name": "account_10",
    "group": "Account",
    "permission": [
    ...
    "description": "<p>Lists an account contacts.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "sampleRequest": [
      {
        "url": "https://api.azalead.com/core/account/:id/contact"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "description": "<p>Returns an account activity overview. Activities are: website visits, ads clicked and emails viewed.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>Returns the account alert’s recipient list.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n  [\n      {\n          \"email\": \"sales4@acme.com.azasand\",\n          \"firstName\": \"John\",\n          \"lastName\": \"Branson\",\n          \"id\": 2375\n      },\n      {\n          \"email\": \"jdeley@acme.com.azasand\",\n          \"firstName\": \"Justin\",\n          \"lastName\": \"Deley\",\n          \"id\": 2261\n      }\n  ]",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "description": "<p>Adds an alert’s recipient for an account.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>the user id that will receive the alerts</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "description": "<p>Removes an alert’s recipient for an account.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
      ...
      "fields": {
        ...
        "ad_clicked activity object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "visitedPages",
            "description": "<p>A list of visitedPage object representing the visited pages</p>"
          },
          {
            "group": "ad_clicked activity object",
            "type": "Object",
        ...
        "website_visit activity object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "visitedPages",
            "description": "<p>The list of pages visited after an ad click</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "Object",
        ...
        "email_viewed activity object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "openers",
            "description": "<p>List of opener objects</p>"
          },
          {
            "group": "email_viewed activity object",
            "type": "String",
        ...
        "visited_page object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "events",
            "description": "<p>List of event objects related to the visit</p>"
          },
          {
            "group": "visited_page object",
            "type": "Number",
        ...
        "event object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "content",
            "description": "<p>The content/data of the event. Will consiste of a key/value json object varying in fonction of the event type.</p>"
          }
        ],
        "opener object": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>Email adress of the person who opened the email</p>"
          },
          {
            "group": "opener object",
            "type": "Number",
    ...
    "examples": [
      {
        "title": "Basic enpoint usage using account identifier:",
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        ...
        {
          "title": "Success-Response website_vist activity:",
          "content": "HTTP/1.1 200 OK\n    {\n        \"type\": \"website_visit\",\n        \"date\": 1507884678000,\n        \"visitedPages\": [\n            {\n                \"title\": \"Blog - Acme\",\n                \"url\": \"https://acme.com/blog/b-to-big-b-is-too-big/\",\n                \"durationInSecond\": 182,\n                \"events\": null,\n                \"id\": 952123136\n            },\n            {\n                \"title\": null,\n                \"url\": \"https://acme.com/blog/blog/b-to-big-b-is-bigger/\",\n                \"durationInSecond\": 1,\n                \"events\": null,\n                \"id\": 952008578\n            }\n        ],\n        \"referer\": {\n            \"idCategory\": \"social\",\n            \"name\": \"blog_amazon_en_twitter\"\n        },\n        \"idPerson\": null,\n        \"id\": 28212776\n    }",
          "type": "json"
        },
        {
