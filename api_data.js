define({ "api": [
  ...
  {
    "type": "get",
    "url": "/latest/account/:id_account/contact",
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/contact",
        "type": "curl"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id_account/contact"
      }
    ],
    "header": {
      "fields": {
