define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account?page=:page&size=:size&sort=:sort&dir=:dir&filter=:filter&target=:target&alert=:alert&blacklist=:blacklist&isp=:isp&labels=:labels&from=:from&to=:to"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account?target=true",
        "type": "curl"
      },
      {
        "title": "Get the last active accounts.",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account",
        "type": "curl"
      }
    ],
    "success": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "screenshot",
            "description": "<p>This account screenshot is available at this url https://mobile.jabmo.com/Azalead-Web/images/:screenshot.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456",
        "type": "json"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/overview",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/overview?from=:from&to=:to"
      }
    ],
    "examples": [
      {
        "title": "Basic endpoint usage :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/overview",
        "type": "curl"
      },
      {
        "title": "Usage with date filtering :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/overview?from=1483225200000&to=1485903600000",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/Account.md",
  ...
  {
    "type": "get",
    "url": "/latest/account/:id_account/alert-recipient",
    ...
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/alert-recipient",
        "type": "json"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id_account/alert-recipient"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -d '{\"id:987654321\"}' -H \"Content-Type: application/json\" -H \"X-Auth-token:Bearer YOUR_TOKEN\" -X POST https://api.jabmo.com/latest/account/123456/alert-recipient",
        "type": "json"
      }
    ],
    "success": {
  ...
  {
    "type": "delete",
    "url": "/latest/account/:id_account/alert-recipient/:id",
    ...
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\" -X DELETE https://api.jabmo.com/latest/account/123456/alert-recipient/987654321",
        "type": "json"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id_account/alert-recipient/:id"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/activity",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/activity?page=:page&size=:size&from=:from&to=:to&types=:types"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/activity",
        "type": "curl"
      },
      {
        "title": "Full endpoint usage with time&type based filtering and pagination:",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/activity?page=3&size=50&from=1430385808000&to=1490123408000&types=website_visit&types=ad_clicked",
        "type": "curl"
      }
    ],
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/activity"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/activity/:id_activity",
    ...
    "description": "<p>Returns a specific account activity.</p> <p>As there are several types of activity (email_viewed,ad_click,website_visit) the returned JSON can change.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      "fields": {
        ...
        "ad_click activity object": [
          {
            "group": "ad_click activity object",
            "type": "String",
            "allowedValues": [
              "\"ad_click\""
            ],
          ...
          },
          {
            ...
            "optional": false,
            "field": "adCreative",
            "description": "<p>An object representing the clicked creative</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "String",
            "optional": false,
            "field": "adProgram.id",
            "description": "<p>The ad creative id</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "String",
            "optional": false,
            "field": "adProgram.name",
            "description": "<p>The name of the ad creative</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "Boolean",
            "optional": false,
            "field": "adProgram.archived",
            "description": "<p>True if the creative has been archived</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "Object",
            "optional": false,
            "field": "adProgram",
            "description": "<p>An object representing the advertising program related to the click</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "String",
            "optional": false,
            "field": "adProgram.type",
            "description": "<p>The type of the program</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "String",
            "optional": false,
            "field": "adProgram.audience",
            "description": "<p>The type of audience of the program</p>"
          },
          {
            "group": "ad_click activity object",
            "type": "Boolean",
            "optional": false,
            "field": "adProgram.active",
            "description": "<p>True if the program is currently active</p>"
          }
        ],
        "website_visit activity object": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "utm",
            "description": "<p>The UTMs associated to the website visit</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "utm.utmSource",
            "description": "<p>The utm source</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "String",
            "optional": false,
            "field": "utm.utmMedium",
            "description": "<p>The utm medium</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "String",
            "optional": false,
            "field": "utm.utmKeyword",
            "description": "<p>The utm keyword</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "String",
            "optional": false,
            "field": "utm.utmContent",
            "description": "<p>The utm content</p>"
          },
          {
            "group": "website_visit activity object",
            "type": "Number",
      ...
      "examples": [
        ...
        {
          "title": "Success-Response ad_click activity:",
          "content": "HTTP/1.1 200 OK\n    {\n        \"type\": \"ad_click\",\n        \"date\": 1516894524324,\n        \"adProgram\": {\n            \"name\": \"IP Targeting - Sequence- BEBOP\",\n            \"type\": \"IP_TARGETING\",\n            \"audience\": \"IP Targeting - Sequence- BEBOP\",\n            \"active\": true,\n            \"id\": 12653\n        },\n        \"adCreative\": {\n            \"name\": \"SE_BEBOP_160x600\",\n            \"archived\": false,\n            \"id\": 74278\n        },\n        \"id\": 37122\n    }",
          "type": "json"
        }
      ]
    },
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/activity/7654321",
        "type": "json"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/activity/AccountActivity.md",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/activity/:id_activity"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/visited-page/overview",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/visited-page/overview?from=:from&to=:to"
      }
    ],
    "success": {
      "fields": {
    ...
    "examples": [
      {
        "title": "Basic endpoint usage : ",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/visited-page/overview",
        "type": "curl"
      },
      {
        "title": "Full endpoint usage with time filter :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/visited-page/overview?from=1430385808000&to=1490123408000",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/activity/AccountActivity.md",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/referer?from=:from&to=:to"
      }
    ],
    "success": {
      "fields": {
      ...
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n   [\n    {\n        \"idCategory\": \"azalead_ad\",\n        \"name\": \"jabmo ad nurturing ABR Tradeshow NYC August\",\n        \"visitCount\": 8\n    },\n    {\n        \"idCategory\": \"azalead_ad\",\n        \"name\": \"jabmo ad nurturing ABR Case Study\",\n        \"visitCount\": 8\n    },\n    {\n        \"idCategory\": \"organic_search\",\n        \"name\": \"Bing\",\n        \"visitCount\": 8\n    },\n    {\n        \"idCategory\": \"azalead_ad\",\n        \"name\": \"jabmo ad nurturing ABR White Paper\",\n        \"visitCount\": 7\n    },\n    {\n        \"idCategory\": \"organic_search\",\n        \"name\": \"Google\",\n        \"visitCount\": 6\n    },\n    {\n        \"idCategory\": \"social\",\n        \"name\": \"Facebook\",\n        \"visitCount\": 5\n    },\n    {\n        \"idCategory\": \"social\",\n        \"name\": \"Linkedin\",\n        \"visitCount\": 4\n    },\n    {\n        \"idCategory\": \"social\",\n        \"name\": \"Twitter\",\n        \"visitCount\": 4\n    },\n    {\n        \"idCategory\": \"direct\",\n        \"name\": null,\n        \"visitCount\": 4\n    },\n    {\n        \"idCategory\": \"paid_search\",\n        \"name\": \"Adwords\",\n        \"visitCount\": 3\n    },\n    {\n        \"idCategory\": \"organic_search\",\n        \"name\": \"Yahoo!\",\n        \"visitCount\": 3\n    }\n   ]",
          "type": "json"
        }
      ]
    },
    ...
    "examples": [
      {
        "title": "Basic endpoint usage : ",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/referer",
        "type": "curl"
      },
      {
        "title": "Full endpoint usage with time filter :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/referer?from=1430385808000&to=1490123408000",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/activity/AccountActivity.md",
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/referer/category",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/referer/category?from=:from&to=:to"
      }
    ],
    "success": {
      "fields": {
    ...
    "examples": [
      {
        "title": "Basic endpoint usage : ",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/referer/category",
        "type": "curl"
      },
      {
        "title": "Full endpoint usage with time filter :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/referer/category?from=1430385808000&to=1490123408000",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/activity/AccountActivity.md",
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/event/type",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/event/type?from=:from&to=:to"
      }
    ],
    "success": {
      "fields": {
    ...
    "examples": [
      {
        "title": "Basic endpoint usage :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/event/type",
        "type": "curl"
      },
      {
        "title": "Full endpoint usage with time filter :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/123456/event/type?from=1430385808000&to=1490123408000",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/account/activity/AccountActivity.md",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "cURL :",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/activity/person/ba1102bf-68f2-41b5-ad08-b836eebe2551",
        "type": "json"
      }
    ],
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/activity/person/:id"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/latest/authenticate",
    "title": "Authenticate user",
    "version": "0.0.1",
    "name": "authenticate_2",
    "group": "Authentication",
    "description": "<p>All requests to Jabmo's REST API require you to authenticate. Send your Jabmo user login and password to get your JSON Web Token. You will need this token to make API calls.</p>",
    "header": {
      "fields": {
        "Header": [
          {
    ...
    "examples": [
      {
        "title": "Get a token. ",
        "content": "curl -H \"Content-type: application/json\" -X POST https://api.jabmo.com/latest/authenticate -d '{ \"username\":\"YOUR_USERNAME\",\"password\":\"YOUR_PASSWORD\"}'",
        "type": "json"
      }
    ],
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/authenticate"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/label"
      }
    ],
    "success": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/label",
        "type": "curl"
      }
    ],
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/label/:id"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/label/8315",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/label/Label.md",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Get a specific label.",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\" -X POST  https://api.jabmo.com/latest/label  -d { \"label\": \"NEW_LABEL\" }",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/label/Label.md",
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Update a label.",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/label/8315  -d { \"label\": \"LABEL_UPDATE\" }",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/core/label/Label.md",
  ...
  {
    "type": "get",
    "url": "/latest/account/:id/opportunity",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/opportunity?closed=:closed&won=:won"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>Specifies the name of the account in the external source system.</p>"
          }
        ]
      }
    },
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/1837/opportunity",
        "type": "curl"
      },
      {
        "title": "Get all open opportunities for the given account.",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/1837/opportunity?closed=false&won=false",
        "type": "curl"
      }
    ],
    "success": {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "owner",
            "description": "<p>The owner of the opportunity.</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
  ...
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n  [\n   {\n    \"dealSize\": 85000,\n    \"closedDate\": 1471478400000,\n    \"name\": \"Opportunity 2533639\",\n    \"probabilityPercentage\": 50,\n    \"closed\": false,\n    \"won\": false,\n    \"idUser\": 2375,\n    \"idAccount\": 1837,\n    \"id\": 2524,\n    \"source\": \"salesforce\",\n    \"externalId\": \"003a000300OH9mFRRO\",\n    \"externalAccount\": \"PROCTER & GAMBLE CO\"\n    }\n  ]",
          "type": "json"
        }
      ],
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/account/:idAccount/opportunity/:idOpportunity",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:idAccount/opportunity/:idOpportunity"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/1837/opportunity/2524",
        "type": "curl"
      }
    ],
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n   {\n    \"dealSize\": 85000,\n    \"closedDate\": 1471478400000,\n    \"name\": \"Opportunity 2533639PROCTER & GAMBLE CO\",\n    \"probabilityPercentage\": 50,\n    \"closed\": false,\n    \"won\": false,\n    \"owner\": \"Brandon McClaine\",\n    \"idAccount\": 1837,\n    \"id\": 2524,\n    \"source\": \"salesforce\",\n    \"externalId\": \"003a000300OH9mFRRO\",\n    \"externalAccount\": \"PROCTER & GAMBLE CO\"\n    }",
          "type": "json"
        }
      ],
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/account/:id/opportunity/"
      }
    ],
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "owner",
            "defaultValue": "authenticated user name",
            "description": "<p>The owner of the opportunity. Only an administrator can specify this field. If not specified the authenticated user is used.</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "owner",
            "description": "<p>The owner of the opportunity. Only an administrator can specify this field.</p>"
          },
          {
            "group": "Parameter",
            "type": "string",
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/account/1837/opportunity  -d { \"idAccount\": 1643, \"probabilityPercentage\": 70 }'",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/opportunity?closed=:closed&won=:won"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "examples": [
      {
        ...
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/opportunity",
        "type": "curl"
      },
      {
        "title": "Get all open opportunities.",
        "content": "curl -H \"X-Auth-token:Bearer YOUR_TOKEN\"  https://api.jabmo.com/latest/opportunity?closed=false&won=false",
        "type": "curl"
      }
    ],
    "success": {
  ...
  },
  {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "trackerCode",
            "description": "<p>Your organization tracker code used by Jabmo to identify your organization for example email pixels.</p>"
          },
          {
            "group": "Success 200",
            "type": "string",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/latest/organization/websiteTrackerCode",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/websiteTrackerCode"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "post",
    "url": "/latest/organization/emailTrackerCode",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/emailTrackerCode"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/user"
      }
    ]
  },
  {
    "type": "get",
    "url": "/latest/organization/user/config",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/user/config"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/organization/user/config/alert_email",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/user/config/alert_email"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "delete",
    "url": "/latest/organization/user/:id",
    "title": "Remove a user",
    "version": "0.0.12",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/organization/user/:id"
      }
    ],
    "success": {
      "fields": {
  ...
  },
  {
    ...
    "description": "<p>Sends the &quot;Forgot Password&quot; email for the requested login. The link in this email is valid for limited time, depending on the platform configuration. If the email, provided in the request, does not represent valid Jabmo user login, nothing happens.</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "examples": [
      {
        "title": "Example: ",
        "content": "curl -H \"Content-type: application/json\" -X POST https://api.jabmo.com/public/password/forgot -d '{ \"email\":\"john.smith@gmail.com\" }'",
        "type": "curl"
      }
    ],
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/public/password/forgot"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example: ",
        "content": "curl -H \"Content-type: application/json\" -X POST https://api.jabmo.com/public/password/forgot -d '{ \"token\":\"XXXXXXXXXXXXXXX\" }'",
        "type": "curl"
      }
    ],
    "filename": "src/main/java/com/azalead/api/endpoint/anonymous/resetPassword/ResetPassword.md",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/public/password/reminder"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Valid example: ",
        "content": "curl -H \"Content-type: application/json\" -X POST https://api.jabmo.com/public/signUp -d '{ \"firstName\":\"John\",\"lastName\":\"Smith\",\"email\":\"john.smith@gmail.com\",\"password\":\"1aA$$$\",\"website\":\"http://google.com\",\"company\":\"Google Inc\"}'",
        "type": "curl"
      }
    ],
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/public/signUp"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/ref/country"
      }
    ],
    "header": {
      "fields": {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/ref/industry"
      }
    ],
    "header": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/latest/ref/company-category",
    "title": "Categories",
    "version": "0.0.1",
    "name": "ref_data_3",
    "group": "Reference",
    ...
    "sampleRequest": [
      {
        "url": "https://api.jabmo.com/latest/ref/company-category"
      }
    ],
    "header": {
      "fields": {
